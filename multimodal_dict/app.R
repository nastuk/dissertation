...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem("Wordcloud", icon = icon("icons"), startExpanded = TRUE,
             menuSubItem("Keywords", tabName = "freq_en"),
             menuSubItem("Ключевые слова", tabName = "freq_ru")

    ),
    menuItem("Русский язык", icon = icon("language"), startExpanded = TRUE,
    ...
    menuItem("English", icon = icon("globe-europe"), startExpanded = TRUE,
...
body <- dashboardBody(
  tabItems(
    tabItem(tabName = "freq_en",
            ...
            tags$a(href="https://www.education-today.co.uk/", 
        ...
        tabItem(tabName = "freq_ru",
            ...
            font-size: 17px;",
            "по материалам",
            tags$a(href="http://edu-inform.ru/", 
    ...
    tabItem("sci_ru",
            ...
            fluidRow(
              tabBox(title = tagList(h5(tags$i("Сущ., неодуш., жен. род, 1-е скл."))),
                     ...
                     tabPanel("Этимология", 
                              style = "outline-style: dotted; outline-color: #5dbb63; outline-offset: 5px; font-size: 15px;",
              ...
              infoBox("Произношение", "[nɐˈukə]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "наука.mp3", type = "audio/mp3", 
            ...
            fluidRow(width = 6,
                     box( img(src = "наука.jpg", height = 330)
                     ),
                     box(HTML('<iframe width="500" height="315" 
    ...
    tabItem("edu_ru",
            ...
            fluidRow(
              ...
              infoBox("Произношение", "[ɐbrəzɐˈvanʲɪɪ̯ə]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "образование.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
            ...
            fluidRow(width = 6,
              box( img(src = "образование.png", height = 315)
              ),
              box(HTML('<iframe width="500" height="315" 
    ...
    tabItem("teach_ru", 
            ...
            fluidRow(
              ...
              infoBox("Произношение", "[prʲɪpədɐˈvatʲɪlʲ]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "преподаватель.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
            ...
            fluidRow(width = 6,
                     box( img(src = "преподаватель.jpg", height = 335)
                     )
            )
    ),
    tabItem("prof_ru", 
            ...
            fluidRow(
              ...
              infoBox("Произношение", "[prəfʲɪsʲɪɐˈnalʲnɨɪ̯]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "профессиональный.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
    ...
    tabItem("man_ru", 
            ...
            fluidRow(
              ...
              infoBox("Произношение", "[rʊkəvɐˈdʲitʲɪlʲ]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "руководитель.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
    ...
    tabItem("stud_ru", 
            ...
            fluidRow(
              ...
              infoBox("Произношение", "[stʊˈdʲent]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "студент.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
    ...
    tabItem("uni_ru", 
            ...
            fluidRow(
              ...
              infoBox("Произношение", "[ʊnʲɪvʲɪrsʲɪˈtʲet] ", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "университет.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
            ...
            fluidRow(width = 6,
                     box( img(src = "университет.jpg", height = 280)
                     ),
                     box(HTML('<iframe width="500" height="315" 
    ...
    tabItem("acad_ru",             
            ...
            fluidRow(
              ...
              infoBox("Произношение", "[ʊˈt͡ɕebnɨɪ̯]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "учебный.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
    ...
    tabItem("schol_ru",             
            ...
            fluidRow(
              ...
              infoBox("Произношение", "[ˈʂkoɫə]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "школа.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
            ...
            fluidRow(width = 6,
              box( img(src = "школа.jpg", height = 335)
              ),
              box(HTML('<iframe width="500" height="315"
    ...
    tabItem("ex_ru",             
            ...
            fluidRow(
              tabBox(title = tagList(h5(tags$i("Сущ., неодуш., муж. род, 2-е скл."))),
                     ...
                     tabPanel("Значение",
                              style = "font-size: 15px;",
                              tags$b("1."),
                              "проверочное испытание по какому-л. учебному предмету 
              ...
              infoBox("Произношение", "[ɛɡˈzamʲɪn]", icon = icon("volume-up"), 
                      color = "green", width = 5,
                      tags$audio( src = "экзамен.mp3", type = "audio/mp3", 
                                  autoplay = FALSE, controls = TRUE)
              ),
              infoBox("Примеры", "Национальный корпус русского языка", icon = icon("stream"), 
                      color = "olive", width = 5,
            ...
            fluidRow(
                     box(width = 4,
                         img(src = "экзамен.png", height = 480)
                     ),
                     box(width = 8,
    ...
    tabItem("acad_en",
            ...
            fluidRow(
              tabBox(title = tagList(h4(tags$i("adjective"))),
                     ...
                     tabPanel("Etymology",
                              style = "outline-style: dotted; outline-color: #5dbb63; outline-offset: 5px; font-size: 17px;",
    ...
    tabItem("sci_en",
            ...
            fluidRow(
              box(img(src = "наука.jpg", height = 325)),
              box(HTML('<iframe width="500" height="315" 
    ...
    tabItem("about", 
            fluidRow(
              box(width = 12,
                  ...
                  h2("About | О словаре", style = "color: green; text-align: center;"),
              ...
              box(width = 12,
                  ...
                  h3("Disclaimer", style = "color: navy; text-align: center;"),
